...
typedef struct evm_object_native_t {
    ...
    evm_val_t (*setter)(evm_t * e, evm_val_t * p, evm_hash_t name, int argc, evm_val_t * v);
    evm_val_t (*getter)(evm_t * e, evm_val_t * p, evm_hash_t name, int argc, evm_val_t * v);
    evm_val_t (*caller)(evm_t * e, evm_val_t * p, int argc, evm_val_t * v);

    evm_val_t (*get_prop)(evm_t * e, evm_val_t * p, evm_hash_t name, int argc, evm_val_t * v);
    evm_val_t (*set_prop)(evm_t * e, evm_val_t * p, evm_hash_t name, int argc, evm_val_t * v);
