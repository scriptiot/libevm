...
EVM_API evm_val_t ecma_builtin_get_prop(evm_t * e, evm_val_t * p, evm_hash_t name, int argc, evm_val_t *v);
EVM_API evm_val_t ecma_builtin_set_prop(evm_t * e, evm_val_t * p, evm_hash_t name, int argc, evm_val_t *v);
